...
# Filters
Filts <- c("0.00", "0.50", "0.70", "0.80", "0.90", "0.95")

# Get the imputed inversion names
Inversions <- read.table(paste0(wd,'/../VCFs/30X/Invs2Imp'),col.names = "INV") %>% arrange(INV)
...
Imputation.Info <- Imputation.Info %>% select(-matches("0.30"))
...
Invs.Indiv.Info <- Invs.Indiv.Info %>% select(-matches("0.30"))
...
AFR_Freq <- read.csv(paste0(wd,"/Results_Stats/Inversions_Freq_AFR.txt"), sep = "\t", header = FALSE, 
                     col.names = c("INV", "Freq")) %>% arrange(INV)
...
AFR_MAF <- read.csv(paste0(wd,"/Results_Stats/MAF_Freq_AFR.txt"), sep = "\t", header = FALSE, 
                     col.names = c("INV", "MAF")) %>% arrange(INV)
...
plot_count_true <- function(imp_method, condition = NULL, population, filter = NULL) {
  ...
  if (!is.null(filter)) {
    ...
    filters <- c("0.00","0.50", "0.70", "0.80", "0.90", "0.95")
    }
...
plot_method_vs_indiv <- function(imp_method, condition, pop, plot = TRUE) {
  ...
  if (plot) {
  print(ggplot(melt(df.invs[c(1:5),c(1:7)], id.vars = "INV"), aes(x = variable, y = value, group = INV, color = factor(INV))) +
  geom_line() +
  labs(x = "GP Filter", y = expression(~r^2~""), title = "Inversion Imputability Using Different GP Filters") + scale_x_discrete(labels = c("0.00","0.50", "0.70", "0.80", "0.90", "0.95")))

  print(ggplot(melt(df.indivs.percentages[c(1:5),c(1:7)], id.vars = "INV"), aes(x = variable, y = value, group = INV, color = factor(INV), ymin = 0)) +
  geom_line() +
  labs(x = "GP Filter", y = "% Initial Indivs", title = "Loss of Individuals by Using Different GP Filters") + scale_x_discrete(labels = c("0.00","0.50", "0.70", "0.80", "0.90", "0.95")))
  } else {
    ...
    print(
      summary_df2 %>% 
        ggplot(aes(x = Filter, y = value, group = name, ymin = 0, color = factor(name))) +
            ...
            scale_x_discrete(labels = c("0.00","0.50", "0.70", "0.80", "0.90", "0.95")) + 
  ...
  if (type == "all") {
    ...
    for (condition in conditions) {
      for (pop in pops) { 
        ...
        Beagle_info$Filter <- c(0.00,0.00,0.50,0.50,0.70,0.70,0.80,0.80,0.90,0.90,0.95,0.95)
        ...
        Impute2_info$Filter <- c(0.00,0.00,0.50,0.50,0.70,0.70,0.80,0.80,0.90,0.90,0.95,0.95)
        ...
        Impute5_info$Filter <- c(0.00,0.00,0.50,0.50,0.70,0.70,0.80,0.80,0.90,0.90,0.95,0.95)
        ...
        Minimac4_info$Filter <- c(0.00,0.00,0.50,0.50,0.70,0.70,0.80,0.80,0.90,0.90,0.95,0.95)
        ...
        pop_plot <- ggplot() + Beagle_plot + Impute2_plot + Impute5_plot + Minimac4_plot + 
              ...
              scale_x_continuous(breaks = c(0.00, 0.50, 0.70, 0.80, 0.90, 0.95), labels = c("0.00", "0.50", "0.70", "0.80", "0.90", "0.95")) +
...
#                                 labels = c("Beagle", "Impute2", "Impute5", "Minimac4"),
        ...
        plot_list[[i+1]] <- tableGrob(DF, rows = c(), cols = c("Method", "0.00", "0.50", "0.70", "0.80", "0.90", "0.95")) 
        i <- i + 2
      }
    }
    return(plot_list)
      ...
      for (condition in conditions) {
        ...
        AFR_info$Filter <- c("0.00","0.00","0.50","0.50","0.70","0.70","0.80","0.80","0.90","0.90","0.95","0.95")
        AFR_plot <- geom_line(data = AFR_info, 
                         aes(x = Filter, y = value, ymin = 0, group = name, 
                             linetype = factor(name), color = "AFR"), 
                         inherit.aes = FALSE)
        EUR_info$Filter <- c("0.00","0.00","0.50","0.50","0.70","0.70","0.80","0.80","0.90","0.90","0.95","0.95")
        EUR_plot <- geom_line(data = EUR_info, 
                         aes(x = Filter, y = value, ymin = 0, group = name, 
                             linetype = factor(name), color = "EUR"), 
                         inherit.aes = FALSE)
        EAS_info$Filter <- c("0.00","0.00","0.50","0.50","0.70","0.70","0.80","0.80","0.90","0.90","0.95","0.95")
...
#                                 labels = c("AFR", "EUR", "EAS"),
      ...
      for (pop in pops) {
        ...
        Standard_info$Filter <- c("0.00","0.00","0.50","0.50","0.70","0.70","0.80","0.80","0.90","0.90","0.95","0.95")
        Standard_plot <- geom_line(data = Standard_info, 
                           aes(x = Filter, y = value, ymin = 0, group = name, 
                               linetype = factor(name), color = "BEAGLE_Phase"), 
                           inherit.aes = FALSE)
        Shapeit_Phase_info$Filter <- c("0.00","0.00","0.50","0.50","0.70","0.70","0.80","0.80","0.90","0.90","0.95","0.95")
        ...
        conditions_plot <- ggplot() + Standard_plot + Shapeit_Phase_plot
            ...
            if (spec == "Impute2") {
              ...
              Unphased_info$Filter <- c("0.00","0.00","0.50","0.50","0.70","0.70","0.80","0.80","0.90","0.90","0.95","0.95")
...
```{r, fig.height=10, fig.width = 8, warning=FALSE}
    ...
    Beagle_info$Filter <- c(0.00,0.50,0.70,0.80,0.90,0.95)
    ...
    Impute2_info <- colMeans(Impute2_info[-1], na.rm = TRUE) %>% as.data.frame() %>%
      rownames_to_column(var = "Filter")
    Impute2_info$Filter <- c(0.00,0.50,0.70,0.80,0.90,0.95)
    ...
    Impute5_info <- colMeans(Impute5_info[-1], na.rm = TRUE) %>% as.data.frame() %>%
      rownames_to_column(var = "Filter")
    Impute5_info$Filter <- c(0.00,0.50,0.70,0.80,0.90,0.95)
    ...
    Minimac4_info <- colMeans(Minimac4_info[-1], na.rm = TRUE) %>% as.data.frame() %>%
      rownames_to_column(var = "Filter")
    Minimac4_info$Filter <- c(0.00,0.50,0.70,0.80,0.90,0.95)
...
#                                 labels = c("Beagle", "Impute2", "Impute5", "Minimac4"),
        ...
        plot_list[[2]] <- tableGrob(DF, rows = c(), cols = c("Method", "0.00",  "0.50", "0.70", "0.80", "0.90", "0.95")) 
...
#                                 labels = c("Beagle", "Impute2", "Impute5", "Minimac4"),
        ...
        plot_list[[4]] <- tableGrob(DF, rows = c(), cols = c("Method", "0.00",  "0.50", "0.70", "0.80", "0.90", "0.95"))         
...
#                                 labels = c("Beagle", "Impute2", "Impute5", "Minimac4"),
        ...
        plot_list[[6]] <- tableGrob(DF, rows = c(), cols = c("Method", "0.00",  "0.50", "0.70", "0.80", "0.90", "0.95")) 
```
...
ggpairs(M4.data.AFR[c(9:18)])
ggpairs(I2.data.AFR[c(9:18)])
...
Reduced.M4 <- M4.data.AFR[c(9:16)]
Reduced.I2 <- I2.data.AFR[c(9:16)]
...
colnames(BEAGLE.BEAGLE_Phase.Invs.EUR) <- c("0.00", "0.50", "0.70", "0.80", "0.90", "0.95")
BEAGLE.BEAGLE_Phase.Invs.EUR <- BEAGLE.BEAGLE_Phase.Invs.EUR %>% mutate_at(
  vars(`0.00`,`0.50`, `0.70`, `0.80`, `0.90`, `0.95`), funs(as.character)
)
...
colnames(Impute2.BEAGLE_Phase.Invs.EUR) <- c("0.00", "0.50", "0.70", "0.80", "0.90", "0.95")
...
colnames(Impute5.BEAGLE_Phase.Invs.EUR) <- c("0.00", "0.50", "0.70", "0.80", "0.90", "0.95")
...
colnames(Minimac4.BEAGLE_Phase.Invs.EUR) <- c("0.00", "0.50", "0.70", "0.80", "0.90", "0.95")
...
plot(as.matrix(BEAGLE.BEAGLE_Phase.Invs.EUR[,c(1,3,4)]), xaxt = "n", axis.col = NULL, yaxt = "n",
...
axis(1, line = 5, tick = F, cex.axis = 6, labels = Filts[c(1,3,4)], at = seq(3))
#axis(2, line = 10, tick = F, cex.axis = 7, labels(rownames(BeMtxEUR)), at = seq(length(rownames(BeMtxEUR))))

par(mar = c(20,15,10,1))
plot(as.matrix(Impute2.BEAGLE_Phase.Invs.EUR[,c(1,3,4)]), axis.col = NULL,
...
plot(as.matrix(Impute5.BEAGLE_Phase.Invs.EUR[,c(1,3,4)]), axis.col = NULL,
     axis.row = NULL, ylab = "", xlab = "", col = cols,
...
plot(as.matrix(Minimac4.BEAGLE_Phase.Invs.EUR[,c(1,3,4)]), axis.col = NULL,
     axis.row = NULL, ylab = "", xlab = "", col = cols,
...
colnames(BEAGLE.BEAGLE_Phase.Invs.AFR) <- c("0.00", "0.50", "0.70", "0.80", "0.90", "0.95")
...
colnames(Impute2.BEAGLE_Phase.Invs.AFR) <- c("0.00", "0.50", "0.70", "0.80", "0.90", "0.95")
...
colnames(Impute5.BEAGLE_Phase.Invs.AFR) <- c("0.00", "0.50", "0.70", "0.80", "0.90", "0.95")
...
colnames(Minimac4.BEAGLE_Phase.Invs.AFR) <- c("0.00", "0.50", "0.70", "0.80", "0.90", "0.95")
...
layout( matrix(c(rep(1,38), rep(2,30), rep(3,30), rep(4,30), rep(5, 23), rep(6, 23)), nrow = 1))
plot(as.matrix(BEAGLE.BEAGLE_Phase.Invs.AFR[,c(1,3,4)]), xaxt = "n", axis.col = NULL, yaxt = "n",
     axis.row = list(side = 2, las = 1, cex.axis = 7, line = 8, tick = F), ylab = "", xlab = "", col = cols,
     breaks = round(c(0, seq(100)/100), 2), main = "BEAGLE", digits = 4, text.cell = list(cex=5.4), 
     na.col = "gray", key = NULL, cex.main = 8)
axis(1, line = 5, tick = F, cex.axis = 6, labels = Filts[c(1,3,4)], at = seq(3))
...
par(mar = c(20,15,10,1))
plot(as.matrix(Impute2.BEAGLE_Phase.Invs.AFR[,c(1,3,4)]), axis.col = NULL,
     axis.row = NULL, ylab = "", xlab = "", col = cols,
     breaks = round(c(0, seq(100)/100), 2), main = "IMPUTE2", digits = 4, text.cell = list(cex=5.4), 
     na.col = "gray", key = NULL, cex.lab = 10, cex.main = 8)
axis(1, line = 5, tick = F, cex.axis = 6, labels = Filts[c(1,3,4)], at = seq(3))

plot(as.matrix(Impute5.BEAGLE_Phase.Invs.AFR[,c(1,3,4)]), axis.col = NULL,
     axis.row = NULL, ylab = "", xlab = "", col = cols,
     breaks = round(c(0, seq(100)/100), 2), main = "IMPUTE5", digits = 4, text.cell = list(cex=5.4), 
     na.col = "gray", key = NULL, cex.main = 8)
axis(1, line = 5, tick = F, cex.axis = 6, labels = Filts[c(1,3,4)], at = seq(3))
...
plot(as.matrix(Minimac4.BEAGLE_Phase.Invs.AFR[,c(1,3,4)]), axis.col = NULL,
     axis.row = NULL, ylab = "", xlab = "", col = cols,
     breaks = round(c(0, seq(100)/100), 2), main = "Minimac4", digits = 4, text.cell = list(cex=5.4),
     na.col = "gray", key = NULL, cex.main = 8)
axis(1, line = 5, tick = F, cex.axis = 6, labels = Filts[c(1,3,4)], at = seq(3))
...
colnames(BEAGLE.BEAGLE_Phase.Invs.EAS) <- c("0.00", "0.50", "0.70", "0.80", "0.90", "0.95")
...
colnames(Impute2.BEAGLE_Phase.Invs.EAS) <- c("0.00", "0.50", "0.70", "0.80", "0.90", "0.95")
...
colnames(Impute5.BEAGLE_Phase.Invs.EAS) <- c("0.00", "0.50", "0.70", "0.80", "0.90", "0.95")
...
colnames(Minimac4.BEAGLE_Phase.Invs.EAS) <- c("0.00", "0.50", "0.70", "0.80", "0.90", "0.95")
...
layout( matrix(c(rep(1,38), rep(2,30), rep(3,30), rep(4,30), rep(5, 23), rep(6, 23)), nrow = 1))
plot(as.matrix(BEAGLE.BEAGLE_Phase.Invs.EAS[,c(1,3,4)]), xaxt = "n", axis.col = NULL, yaxt = "n",
     axis.row = list(side = 2, las = 1, cex.axis = 7, line = 8, tick = F), ylab = "", xlab = "", col = cols,
     breaks = round(c(0, seq(100)/100), 2), main = "BEAGLE", digits = 4, text.cell = list(cex=5.4), 
     na.col = "gray", key = NULL, cex.main = 8)
axis(1, line = 5, tick = F, cex.axis = 6, labels = Filts[c(1,3,4)], at = seq(3))
...
par(mar = c(20,15,10,1))
plot(as.matrix(Impute2.BEAGLE_Phase.Invs.EAS[,c(1,3,4)]), axis.col = NULL,
     axis.row = NULL, ylab = "", xlab = "", col = cols,
     breaks = round(c(0, seq(100)/100), 2), main = "IMPUTE2", digits = 4, text.cell = list(cex=5.4), 
     na.col = "gray", key = NULL, cex.lab = 10, cex.main = 8)
axis(1, line = 5, tick = F, cex.axis = 6, labels = Filts[c(1,3,4)], at = seq(3))

plot(as.matrix(Impute5.BEAGLE_Phase.Invs.EAS[,c(1,3,4)]), axis.col = NULL,
     axis.row = NULL, ylab = "", xlab = "", col = cols,
     breaks = round(c(0, seq(100)/100), 2), main = "IMPUTE5", digits = 4, text.cell = list(cex=5.4), 
     na.col = "gray", key = NULL, cex.main = 8)
axis(1, line = 5, tick = F, cex.axis = 6, labels = Filts[c(1,3,4)], at = seq(3))
...
plot(as.matrix(Minimac4.BEAGLE_Phase.Invs.EAS[,c(1,3,4)]), axis.col = NULL,
     axis.row = NULL, ylab = "", xlab = "", col = cols,
     breaks = round(c(0, seq(100)/100), 2), main = "Minimac4", digits = 4, text.cell = list(cex=5.4),
     na.col = "gray", key = NULL, cex.main = 8)
axis(1, line = 5, tick = F, cex.axis = 6, labels = Filts[c(1,3,4)], at = seq(3))
