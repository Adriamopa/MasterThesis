...
write.table(AFR, paste0("Results_Beagle/",condition, "/", rep,"/R2/", inv, "/", fChar, "/AFR.vcf"), sep = "\t", row.names = F, col.names = T,
            quote = F)
write.table(EUR, paste0("Results_Beagle/",condition, "/", rep,"/R2/", inv, "/", fChar, "/EUR.vcf"), sep = "\t", row.names = F, col.names = T,
            quote = F)
write.table(EAS, paste0("Results_Beagle/",condition, "/", rep,"/R2/", inv, "/", fChar, "/EAS.vcf"), sep = "\t", row.names = F, col.names = T,
            quote = F)
