...
do
	...
	do
		...
		bcftools view -s ^$samp --threads 10 -Ov -o $wd/Results_Glimpse2/$condition/$rep/Inversions/$inv/Ref.vcf $wd/Results_Glimpse2/$condition/$rep/Inversions/$inv/$pop.vcf.gz
		...
		## Prepare target
		bcftools view -s $samp --threads 10 -Ov -o $wd/Results_Glimpse2/$condition/$rep/Inversions/$inv/Target.vcf $wd/Results_Glimpse2/$condition/$rep/Inversions/$inv/$pop.vcf.gz
		...
		rm $wd/Results_Beagle/$condition/$rep/Inversions/$inv/Out.vcf.gz $wd/Results_Beagle/$condition/$rep/Inversions/$inv/Out.log $wd/Results_Beagle/$condition/$rep/Inversions/$inv/Ref* $wd/Results_Beagle/$condition/$rep/Inversions/$inv/Target* $wd/Results_Beagle/$condition/$rep/Inversions/$inv/Header
